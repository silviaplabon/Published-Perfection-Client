        ...
        <header class="font-header-font ">
            <div class="container bg-bing-900 text-white md:w-full lg:w-4/5 mx-auto border-t-4 border-b-4" >
                <div class="grid grid-cols-5  justify-center mt-2 mb-2 ">
                    ...
                    <Link to="/adminMaker" class="    font-title text-base  md:text-2xl xl:text-4xl   text-end hover:text-green-500  border-r-2">Add Admin</Link>
                    ...
                    {loggedInUser.email ? <button onClick={() => setLoggedInUser({})} class="  font-title text-base  md:text-2xl xl:text-4xl   text-end hover:text-green-500  border-r-2">Logout</button> :
                        <Link to="/login" class=" font-title text-base  md:text-2xl xl:text-4xl   text-end hover:text-green-500  border-r-2">Login</Link>}
                </div>
